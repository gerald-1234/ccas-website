...
export const Authentication = ({ onCancelLanding }) => {
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 antialiased selection:bg-blue-500 selection:text-white">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-between px-6 sm:px-12 lg:px-16 py-8 overflow-y-auto min-h-screen">
        {/* Header Bar */}
        ...
        <div className="max-w-md w-full mx-auto my-auto space-y-6">
          ...
          {/* Error Alert */}
          {error && (
            <div className="p-3.5 text-xs sm:text-sm text-red-700 bg-red-50 border border-red-200/80 rounded-lg flex items-start gap-2.5 transition-all">
              <svg
          ...
          {!isRegistering ? (
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 text-sm bg-white rounded-lg border border-slate-300 shadow-sm focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 focus:outline-none transition-all placeholder:text-slate-400"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 text-sm bg-white rounded-lg border border-slate-300 shadow-sm focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 focus:outline-none transition-all placeholder:text-slate-400 pr-10"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
            ...
            <form onSubmit={handleRegisterSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm bg-white rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 focus:outline-none transition-all"
                      placeholder="Jane"
                    />
                  </div>
                  <div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full mt-4 py-2.5 px-4 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-medium text-sm rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600/40 transition duration-150 disabled:opacity-60 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
                    <svg
